...
```sh
> sraza @ sraza0522mac ~/code/devops_educative/docker_swarm 17:48:29
$ docker swarm init
Swarm initialized: current node (n49dg9kgkypm6nnpze2x488vk) is now a manager.

To add a worker to this swarm, run the following command:

    docker swarm join --token SWMTKN-1-46pbp05pfkr3coircisfqyqfops1n25sifgb61ylt8r90it67t-4kkwl9dqgdvl6fnb9jen4nne3 192.168.65.3:2377
